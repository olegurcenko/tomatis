    ...
    <div className={isClosing ? styles.popupClosing : styles.popup}>
      <div className={styles.popupContent}>
        <div className={styles.linkColumn}>
		      <Link className={styles.service} onClick={onClose} to={'/tomatis/price'}>Цены</Link>
		      <Link className={styles.service} onClick={onClose} to={'/tomatis/contacts'}>Контакты</Link>
		      <Link className={styles.service} onClick={onClose} to={'/tomatis/reviews'}>Отзывы</Link>
		      <Link className={styles.service} onClick={onClose} to={'/tomatis/about_us'}>О нас</Link>
        </div>
